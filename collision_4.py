...
pygame.init()
background_image = pygame.transform.scale(pygame.image.load("C:\VS_CODES\py_games\bg.jpg"),
...
class sprite(pygame.sprite.Sprite):
    def __init__(self, color, height, width):
        ...
        self.img.fill(pygame.Color("dogder blue"))
        pygame.draw.rect(self.img, color, pygame.Rect(0,0,width, height))
...
sprite2.rect.x, sprite1.rect.y = random.randint(0, SCREEN_WIDTH - sprite1.rect.width), random.randint(0, SCREEN_HEIGHT - sprite1.rect.height)
...
while running:
   ...
   if not won:
        ...
        if sprite1.rect.collidirect(sprite2):
